...
A definition of quotient types is given in \texttt{Quot/Quotient.v}.
\stepcounter{subsection}
\subsection{Other finite colimits}
A definition of Equalizers and Coequalizers is given in \texttt{LimColimCoq/Equalizer.v}
...
\subsubsection{Equalizer and Coequalizer on Graphs}

The equalizer and coequalizer functors are given in \texttt{Grph/EqCoeqFunc.v}
